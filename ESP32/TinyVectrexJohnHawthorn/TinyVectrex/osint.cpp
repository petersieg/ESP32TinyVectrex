...
// BEGIN setPixel
    ...
    for (v = 0; v < vector_draw_cnt; v++) {
        ...
        // int x0=(vectors_draw[v].x0*7)/1024, x1=(vectors_draw[v].x1*7)/1024,
        // y0=((vectors_draw[v].y0/128-32)*900)/1024, y1=((vectors_draw[v].y1/128-32)*900)/1024; sline(  x0,y0,x1,y1,
        // c);
